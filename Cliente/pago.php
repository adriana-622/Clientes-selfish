          ...
          <div class="col-md-6 derecho">
            <div class="sprit">
              <div class="col-md-6 sp">
                <div class="stripe">
                  <img src="../img/2560px-Stripe_Logo,_revised_2016.svg.png" alt="stripe" />
                </div>
              </div>
            </div>
            <div class="col-md-6 formco">
              <form>
                ...
                <div class="row">
                  <div class="col-md-6 nomb">
                    <div class="input">
                      ...
                      <span>
                        <input id="nomt" name="nombre" type="nombre" placeholder=" Nombres " />
                        <span>
                    </div>
                  </div>
                  <div class="col-md-6 apelli">
                    <div class="input">
                      ...
                      <span>
                        <input id="apt" name="apellido" type="apellido" placeholder=" Apellidos" />
                        <span>
                    </div>
                  </div>
                </div>
                <div class="input">
                  ...
                  <span>
                    <input id="informaciont" name="tarjeta" type="tarjeta" placeholder="1228 9387 6942 2349" />
                    <i>
                ...
                <div class="row">
                  <div class="col-md-6 ven">
                    <div class="input">
                      ...
                      <span>
                        <input id="vencimientot" name="vencimiento" type="vencimiento" placeholder="       MM / YY  " />
                        <span>
                    </div>
                  </div>
                  <div class="col-md-6 cvcta">
                    <div class="input">
                      ...
                      <span>
                        <input id="cvct" name="cvctarje" type="cvctarje" placeholder=" CVC" />
                        <span>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-6 pos">
                    <div class="input">
                      ...
                      <span>
                        <input id="cpostal" name="codpostal" type="cpostal" placeholder=" Codigo Postal" />
                        <span>
                    </div>
                  </div>
                </div>
